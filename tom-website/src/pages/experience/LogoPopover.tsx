...
const logoCardClass =
  "logo-img-bg flex items-center justify-center h-32 w-32 rounded-md transition-transform duration-200 scale-up-fancy-on-hover-larger group-hover:shadow-lg dark:bg-white/5";
