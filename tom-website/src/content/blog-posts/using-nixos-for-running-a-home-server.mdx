...
- I had zero faith in the ex-office SSD and PSU, so if this 60 quid machine died, I can replace the whole thing and be back up and running in a few hours (salt, salt, salt).
...
let
  ...
  userConfiguration = {
    ...
    programs.git = {
      enable = true;
      settings.user.name  = "myusername";
      settings.user.email = "myemail@gmail.com";
    };
    ...
    programs.ssh = {
      ...
      matchBlocks = {
        "github.com" = {
          user = "myusername";
          identityFile = "/home/tom/.ssh/github_nixos_server_z240";
        };
      };
    };
  };
